...
- (void)createGapView
{
    CGRect webViewBounds = self.loadWebView.bounds;

    webViewBounds.origin = self.loadWebView.bounds.origin;

    UIView* view = [self newCordovaViewWithFrame:webViewBounds];

    view.autoresizingMask = (UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight);
    [self.loadWebView addSubview:view];
    [self.loadWebView sendSubviewToBack:view];
}
